...
尽管在 [Conda 求解器故障实录：从 Solving Environment 到 libmamba]({% post_url 2025-07-22-Conda求解器故障实录：从SolvingEnvironment到libmamba %}) 一文里面已经对conda进行了详细的批判，然而，批判归批判，用还是得用，挺无奈的就。
