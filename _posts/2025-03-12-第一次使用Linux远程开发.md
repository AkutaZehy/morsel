...
本则笔记大概记录一下使用过程中比较有意思的一些内容，后来把与mask2former相关一些的内容移动到了[这篇文档]({% post_url 2025-04-06-Mask2Former开发排障记录 %})里面。
...
另外需要用OpenVPN连服务器：[下载链接](https://github.com/OpenVPN/openvpn)
